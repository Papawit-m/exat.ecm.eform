...
{
    public class T_TEMP_FED_IMPORT_FLEETCARD_ERROR
    {
        public List<T_TEMP_FED_IMPORT_FLEETCARD_ERROR_LIST> Detail { get; set; } = new List<T_TEMP_FED_IMPORT_FLEETCARD_ERROR_LIST>();
    }
        public class T_TEMP_FED_IMPORT_FLEETCARD_ERROR_LIST
    {
